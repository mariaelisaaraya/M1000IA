...
def create_metadata(data_dir, num_images):
    ...
    metadata_df = pd.read_csv(r'D:/M1000IA/local iACANCER/nuevos eda/nuevosfinal_metadatos.csv')
...
data_dir = 'Imagenes_paraGAN'  # Cambia esto a la ruta de tu carpeta de imágenes
