...
for fold, (train_idx, val_idx) in enumerate(kf.split(dataset)):
    ...
    # Entrenar el modelo
    train_model(model, train_loader, num_epochs=2)  # Ajusta el número de épocas según sea necesario
...
plt.figure(figsize=(10, 7))
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues')  # Aquí puedes añadir los xticklabels y yticklabels si los tienes
