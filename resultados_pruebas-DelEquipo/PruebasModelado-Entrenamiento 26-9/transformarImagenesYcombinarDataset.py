...
# leer archivo con metadatos (por ahora 24-9 toma el que está filtrado para trabajar con menos imagesnes)
...
with h5py.File('datasetCompleto_lesionesV2.h5', 'w') as hdf:
